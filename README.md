...
This marks the initial stage in constructing your inaugural full web application: the AirBnB clone. During this initial phase, a fundamental console was developed utilizing the Cmd Python module. The purpose of this console is to manage the objects throughout the entire project. It has the capability to implement methods such as create, show, update, all, and destroy for the existing classes and subclasses.
...
### Acknowledgements:
To all the peers that contribuited with their knowledge and guide

-
# Authors
odedame bright elo <brightelo1@gmail.com>
Billgate Okoye chibuzor <billgateokoye@gmail.com>
