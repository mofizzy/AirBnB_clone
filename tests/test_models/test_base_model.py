...
# -*- coding: utf-8 -*-
"""
Created on wed Sep  8 13:05:09 2023
@author: odedame bright and billgate okafor
"""
import sys
import unittest
import inspect
...
class TestBaseModel(unittest.TestCase):
    ...
    def setUpClass(cls):
        """
        Set up the class method for the doc tests
        """
        cls.setup = inspect.getmembers(BaseModel, inspect.isfunction)

    def setUp(self):
        """Set up the method for object BM of BAseModel"""
        self.BM = BaseModel()
    ...
    def test_pep8_conformance_BaseModel(self):
        """
        Test that the base_model.py file conform to PEP8
        """
    ...
    def test_pep8_conformance_test_BaseModel(self):
        """
        Test that the test_base_model.py file conform to PEP8
        """
        pep8style = pep8.StyleGuide(quiet=True)
    ...
    def test_module_docstring(self):
        """
        Tests if the module docstring documentation exist
        """
    ...
    def test_func_docstrings(self):
        """
        Tests if the methods docstring documntation exist
        """
        for func in self.setup:
            self.assertTrue(len(func[1].__doc__) >= 1)

    def test_type(self):
        """test if the method for type testing of BaseModel
        """
